...
namespace GerenciadorJogos.Forms
{
    public partial class FormDeletar : Form
    {
        ...
        private void btnRemoverJogo_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection conn = new SqlConnection("Data Source=BUE205D002;Initial Catalog=BDTurmaManha;Persist Security Info=True;User ID=guest01;Password=@Senac2021"); string delete = "DELETE from dbo.Jogos WHERE nome = '" + cboNome.Text + "' AND codigo = '" + cboCodigo.Text + "'";
